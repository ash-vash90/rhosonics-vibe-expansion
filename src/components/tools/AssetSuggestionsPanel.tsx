    ...
    <div className="space-y-4 border border-primary/20 rounded-lg bg-gradient-to-br from-primary/5 to-transparent">
      ...
      <div className="px-4">
        <div className="flex items-center gap-2">
          ...
          <span className="font-mono text-xs text-muted-foreground">Recommended Style:</span>
          <Badge variant="outline" className="bg-primary/10 text-primary border-primary/30">
            {styleInfo.label}
          </Badge>
        </div>
        <p className="font-mono text-xs text-muted-foreground mt-1 ml-6">
          {styleInfo.description}
        </p>
      </div>

      {/* Imagery Prompts Section */}
      <div className="px-4">
        <button
            ...
            {suggestedAssets.imageryPrompts.map((prompt, idx) => (
              ...
              >
                <div className="flex items-start justify-between gap-2">
                  <p className="font-mono text-xs text-foreground/80 flex-1">{prompt}</p>
                  <Button
                    variant="ghost"
                    size="sm"
