...
export const PageBanner = ({ number, title, subtitle, children }: PageBannerProps) => {
  ...
  return (
    <div
      ref={bannerRef}
      className="full-bleed relative overflow-visible md:overflow-hidden -mb-6 md:mb-4 lg:mb-6 px-4 md:px-8 lg:px-12 xl:px-20 pt-16 pb-2 md:pt-14 md:pb-8 lg:pt-16 lg:pb-10 bg-gradient-to-b from-[hsl(var(--slate-50))] to-background"
    >
