...
export const ColorMatrix = () => {
  return (
    <section id="colors" className="mb-32">
      ...
      {/* Signal Colors - full width */}
      <div className="mb-12">
        <h3 className="label-tech text-primary mb-6">SIGNAL COLORS</h3>
      ...
      {/* Slate Scale + Gradients */}
      <div className="grid lg:grid-cols-2 gap-8">
        <div>
          <h3 className="label-tech text-slate-500 mb-4">SLATE SCALE — UI STRUCTURE</h3>
          <div className="grid grid-cols-5 lg:grid-cols-10 gap-2 mb-4">
            {[
          ...
          <p className="text-sm text-muted-foreground">
            Cool, blue-biased neutrals for all software interfaces.
          </p>
        </div>
        ...
        <div>
          ...
          <div className="grid grid-cols-3 gap-4">
            <div className="h-20 bg-brand-gradient rounded-lg flex items-end p-3">
              <span className="font-ui font-bold text-primary-foreground text-sm">Primary</span>
            </div>
            <div className="h-20 bg-obsidian-gradient rounded-lg flex items-end p-3">
              <span className="font-ui font-bold text-slate-100 text-sm">Obsidian</span>
            </div>
            <div className="h-20 rounded-lg flex items-end p-3" style={{
              background: 'linear-gradient(145deg, hsl(45 10% 58%) 0%, hsl(45 8% 52%) 100%)'
            }}>
              <span className="font-ui font-bold text-white text-sm">Mineral</span>
            </div>
          </div>
        </div>
      </div>
