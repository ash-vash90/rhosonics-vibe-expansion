...
const ENTRIES: Entry[] = [
  ...
  { num: "02", label: "Positioning", path: "/positioning" },
  { num: "03", label: "Principles", path: "/principles" },
  { num: "04", label: "Visual system", path: "/visual-system" },
  { num: "05", label: "Color", path: "/color" },
  { num: "06", label: "Typography", path: "/typography" },
  { num: "07", label: "Logo & assets", path: "/logo-assets" },
  { num: "08", label: "Imagery", path: "/imagery" },
  { num: "09", label: "Applications", path: "/applications" },
  { num: "09.0", label: "Patterns showcase", hint: "Capabilities · proof · pinned", path: "/applications", hash: "patterns" },
  { num: "09.1", label: "Industry applications", hint: "Field outcomes · fact file", path: "/applications", hash: "applications" },
  { num: "09.2", label: "SDM Eco interface", hint: "HMI specimen", path: "/applications", hash: "sdm-interface" },
  { num: "09.3", label: "Eco components", path: "/applications", hash: "components" },
  { num: "09.4", label: "Empty states", path: "/applications", hash: "empty-states" },
  { num: "10", label: "Proof", path: "/proof" },
  { num: "11", label: "Tools", path: "/tools" },
  { num: "12", label: "Review", path: "/review" },
];
