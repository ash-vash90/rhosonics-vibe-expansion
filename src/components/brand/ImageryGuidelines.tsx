...
const textures = [
  {
    ...
    pattern: `url("data:image/svg+xml,%3Csvg width='12' height='12' viewBox='0 0 12 12' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M5 0v2h2V0H5zm0 10v2h2v-2H5zM0 5v2h2V-2H0zm10 0v2h2V-2h-2z' fill='%2333993c' fill-opacity='.12'/%3E%3C/svg%3E")`,
    rawSvg: `<svg width="12" height="12" viewBox="0 0 12 12" xmlns="http://www.w3.org/2000/svg"><path d="M5 0v2h2V0H5zm0 10v2h2v-2H5zM0 5v2h2V5H0zm10 0v2h2V5h-2z" fill="#33993c" fill-opacity="OPACITY_PLACEHOLDER"/></svg>`,
  ...
  },
  {
    ...
    pattern: `url("data:image/svg+xml,%3Csvg width='10' height='10' viewBox='0 0 10 10' xmlns='http://www.w3.org/2000/svg'%3E%3Cpath d='M5 0l5 5-5 5L0 5z' fill='none' stroke='%2333993c' stroke-opacity='.08' stroke-width='.5'/%3E%3Ccircle cx='5' cy='5' r='.5' fill='%2333993c' fill-opacity='.1'/%3E%3C/svg%3E")`,
    rawSvg: `<svg width="10" height="10" viewBox="0 0 10 10" xmlns="http://www.w3.org/2000/svg"><path d="M5 0l5 5-5 5L0 5z" fill="none" stroke="#33993c" stroke-opacity="OPACITY_PLACEHOLDER" stroke-width=".5"/><circle cx="5" cy="5" r=".5" fill="#33993c" fill-opacity="OPACITY_PLACEHOLDER"/></svg>`,
    bgClass: "bg-rho-obsidian",
    opacity: "opacity-100",
    category: "brand",
  },
