    ...
    <section id="components" className="mb-32">
      ...
      <div className="grid lg:grid-cols-3 gap-8 mb-12">
        <div className="lg:col-span-2">
          ...
          <div className="card-base p-8">
            <h3 className="label-tech text-slate-500 mb-6">BUTTONS</h3>
        ...
        {/* Sidebar */}
        <div>
          <BrandCallout variant="rule" title="Data Priority Rule">
      ...
      <div className="grid lg:grid-cols-2 gap-8">
        ...
        <div className="p-6 bg-slate-50 border border-slate-200 rounded-lg">
          <h4 className="font-ui font-semibold text-foreground mb-3">Badge rules</h4>
          <p className="text-sm text-muted-foreground">
            Badges use JetBrains Mono, uppercase, short labels. They communicate state, not emotion.
            Color indicates operational status, never decoration.
          </p>
        </div>
      </div>
    </section>
