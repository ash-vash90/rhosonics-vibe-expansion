...
const SectionHeader = ({ number, title, subtitle, id }: SectionHeaderProps) => {
      ...
      <main className="px-6 md:px-12 lg:px-20 max-w-[1400px] mx-auto">
        ...
        <section className="py-16 md:py-24">
          <SectionHeader 
            ...
            subtitle="What the Rhosonics brand must communicate."
          />
        ...
        <section className="py-16 md:py-24">
          <SectionHeader 
            ...
            subtitle="Decision-making tools for resolving design ambiguity."
          />
        ...
        <section className="py-16 md:py-24">
          <SectionHeader 
            ...
            subtitle="How the system is structured in layers."
          />
        ...
        <section className="py-16 md:py-24">
          <SectionHeader 
            ...
            number="06" 
            title="Logo & Assets" 
            subtitle="Logo system, icons, and brand marks."
          />
        ...
        <section className="py-16 md:py-24">
          <SectionHeader 
            ...
            number="07" 
            title="Voice & Tone" 
            subtitle="Direct. Technical. Confident. No fluff, no hedging."
          />
        ...
        <section className="py-16 md:py-24">
          <SectionHeader 
            ...
            subtitle="Photography, illustration, and animation guidelines."
          />
        ...
        <section className="py-16 md:py-24">
          <SectionHeader 
            ...
            number="09" 
            title="Applications" 
            subtitle="Industry use cases, components, and interface patterns."
          />
